...
public class TruckFlagEncoder extends CarFlagEncoder {
    ...
    private boolean softOneways = false;
    private int axes = 2;
    ...
    public TruckFlagEncoder setIsTaxi(boolean isTaxi) {
        this.isTaxi = isTaxi;
        this.isPSV = isTaxi;
        return this;
    }
    ...
    public TruckFlagEncoder setSoftOneway(boolean softOneway) {
        this.softOneways = softOneway;
        return this;
    }
    ...
    public void createEncodedValues(List<EncodedValue> registerNewEncodedValue, String prefix, int index) {
        ...
        BooleanEncodedValue originalAccessEnc = new SimpleBooleanEncodedValue(EncodingManager.getKey(prefix, "access"), true);
        registerNewEncodedValue.add(originalAccessEnc);
        accessEnc = new AllTrueBooleanEncodedValue(originalAccessEnc, prefix);
    ...
    public TransportationMode getTransportationMode() {
        return isPSV ? TransportationMode.PSV : isCarLike() ? TransportationMode.CAR : TransportationMode.HGV;
    }
    ...
    private static class AllTrueBooleanEncodedValue implements BooleanEncodedValue {

        private final String prefix;
        private final BooleanEncodedValue originalAccessEnc;

        public AllTrueBooleanEncodedValue(BooleanEncodedValue originalAccessEnc, String prefix) {
            this.prefix = prefix;
            this.originalAccessEnc = originalAccessEnc;
        }
        ...
        public String getName() {
            return EncodingManager.getKey(prefix, "access");
        }
        ...
        @Override
        public void setBool(boolean reverse, IntsRef intsRef, boolean b) {
            originalAccessEnc.setBool(reverse, intsRef, b);
        }

        @Override
        public boolean getBool(boolean reverse, IntsRef intsRef) {
