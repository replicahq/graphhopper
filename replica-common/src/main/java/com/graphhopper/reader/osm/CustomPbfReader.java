 ...
 */
public class CustomPbfReader implements Runnable {
     ...
     */
    public CustomPbfReader(InputStream in, Sink sink, int workers) {
        this.inputStream = in;
        this.sink = sink;
    ...
    public void run() {
        ...
        try {
            ...
            CustomPbfDecoder pbfDecoder = new CustomPbfDecoder(streamSplitter, executorService, workers + 1, sink);
            pbfDecoder.run();
