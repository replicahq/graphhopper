...
public class CustomPbfDecoder {
     ...
     */
    public CustomPbfDecoder(PbfStreamSplitter streamSplitter, ExecutorService executorService, int maxPendingBlobs,
                      Sink sink) {
    ...
    private void processBlobs() {
        ...
        while (streamSplitter.hasNext()) {
            ...
            CustomPbfBlobDecoder blobDecoder = new CustomPbfBlobDecoder(rawBlob.getType(), rawBlob.getData(), decoderListener);
