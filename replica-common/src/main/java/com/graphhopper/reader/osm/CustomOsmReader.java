...
public class CustomOsmReader {
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomOsmReader.class);
    ...
    public void readGraph() throws IOException {
        ...
        CustomWaySegmentParser waySegmentParser = new CustomWaySegmentParser.Builder(baseGraph.getNodeAccess())
    ...
    /**
     * This method is called for each way during the first and second pass of the {@link CustomWaySegmentParser}. All OSM
    ...
    /**
     * This method is called during the second pass of {@link CustomWaySegmentParser} and provides an entry point to enrich
    ...
    /**
     * This method is called for each segment an OSM way is split into during the second pass of {@link CustomWaySegmentParser}.
     *
     ...
     */
    protected void preprocessWay(ReaderWay way, CustomWaySegmentParser.CoordinateSupplier coordinateSupplier) {
     ...
     */
    private double calcDistance(ReaderWay way, CustomWaySegmentParser.CoordinateSupplier coordinateSupplier) {
    ...
    /**
     * This method is called for each relation during the first pass of {@link CustomWaySegmentParser}
     */
    ...
    /**
     * This method is called for each relation during the second pass of {@link CustomWaySegmentParser}
