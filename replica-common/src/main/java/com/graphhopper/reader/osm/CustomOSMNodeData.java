...
class CustomOSMNodeData {
    ...
    /**
     * Replica-specific hack to return a mapping of Graphhopper node ID -> OSM node ID, populated by
     * reversing the idsByOsmNodeIds map that's stored during OSM import.
     *
